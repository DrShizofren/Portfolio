    ...
    <>
      <nav>
        ...
        <ul className="nav-links">
          ...
          <li><a href="/resume.pdf" download className="nav-resume-btn">Download Resume</a></li>
        </ul>
      ...
      <div className={`nav-drawer${open ? ' open' : ''}`}>
        <ul className="nav-drawer-links">
          ...
          <li><a href="/resume.pdf" download onClick={close} className="nav-resume-btn">Download Resume</a></li>
        </ul>
      </div>
    </>
  );
