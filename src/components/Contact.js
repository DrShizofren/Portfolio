...
const EMAIL = 'aslancaafarov@gmail.com';
        ...
        <div className="contact-inner reveal">
          ...
          <div className="contact-links">
            <a
              href={`mailto:${EMAIL}`}
              onClick={copyEmail}
              className={`contact-link contact-link-email${copied ? ' is-copied' : ''}`}
              aria-live="polite"
            >
              <span className="contact-swap contact-swap-icon">
                <span className="contact-swap-item">
              ...
              <span className="contact-swap">
                <span className="contact-swap-item">{EMAIL}</span>
                <span className="contact-swap-item">Email copied!</span>
              </span>
            </a>
            ...
            <a href="https://wa.me/994559974407" target="_blank" rel="noopener noreferrer" className="contact-link">
            ...
            <a href="https://github.com/AslanJafarov" target="_blank" rel="noopener noreferrer" className="contact-link">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://www.linkedin.com/in/aslan-cafarov-b5145830a" target="_blank" rel="noopener noreferrer" className="contact-link">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
